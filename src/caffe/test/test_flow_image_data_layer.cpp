...
class FlowImageDataLayerTest : public MultiDeviceTest<TypeParam> {
  typedef typename TypeParam::Dtype Dtype;

 protected:
  FlowImageDataLayerTest()
      : seed_(1701),
  ...
  virtual ~FlowImageDataLayerTest() {
...
TYPED_TEST_CASE(FlowImageDataLayerTest, TestDtypesAndDevices);

TYPED_TEST(FlowImageDataLayerTest, TestRead) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter param;
  FlowImageDataParameter* image_data_param = param.mutable_flow_image_data_param();
  image_data_param->set_batch_size(5);
  image_data_param->set_source(this->filename_.c_str());
  image_data_param->set_shuffle(false);
  FlowImageDataLayer<Dtype> layer(param);
...
TYPED_TEST(FlowImageDataLayerTest, TestResize) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter param;
  FlowImageDataParameter* image_data_param = param.mutable_flow_image_data_param();
  image_data_param->set_batch_size(5);
...
TYPED_TEST(FlowImageDataLayerTest, TestReshape) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter param;
  FlowImageDataParameter* image_data_param = param.mutable_flow_image_data_param();
...
TYPED_TEST(FlowImageDataLayerTest, TestShuffle) {
  typedef typename TypeParam::Dtype Dtype;
  LayerParameter param;
  FlowImageDataParameter* image_data_param = param.mutable_flow_image_data_param();
  image_data_param->set_batch_size(5);
